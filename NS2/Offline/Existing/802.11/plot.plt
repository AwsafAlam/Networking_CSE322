...
plot  "data.out" using 1:2  with lines title "Throughput" lw 2,\
"data.out" using 1:3 title 'Avg delay' with linespoints lw 2,\
...
"data.out" using 1:10 title 'Total Energy' with linespoints lw 2,\
