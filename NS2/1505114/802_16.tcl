...
lappend eilastlevel 1 [expr ($node_numb+1)] 		;# number of nodes for each cluster (1 for sink and one for mobile nodes + base station
AddrParams set nodes_num_ $eilastlevel
puts "Configuration of hierarchical addressing done"

# Create God
create-god [expr ($node_numb + 2)]				;# node_numb + 2 (base station and sink node)
...
for {set i 0} {$i < $node_numb} {incr i} {
    ...
    $udp_($i) set packetSize_ $cbr_size
...
# Run the simulation
puts "Running simulation for $node_numb mobile nodes..."
$ns run
