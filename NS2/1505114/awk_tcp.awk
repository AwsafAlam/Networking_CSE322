...
#			printf("%15.5f   %15.5f\n", rDelay[idPacket], rReceivedTime[ idPacket] - rSentTime[ idPacket ]);
	...
	# if (($1 == "s" || $1 == "f") && $4 == "RTR" && ($35 =="AODV" || $35 =="message" || $35 =="DSR" || $35 =="OLSR")){
...
#	printf( "AverageDelay: %15.5f PacketDeliveryRatio: %10.2f\n", rAverageDelay, rPacketDeliveryRatio ) ;
	...
	printf("%15.5f\n%15.5f\n%15.5f\n%15.5f\n%15.0f\n%15.9f\n%15.5f\n", total_energy_consumption, avg_energy_per_bit, avg_energy_per_byte, avg_energy_per_packet, total_retransmit, rEnergyEfficeincy,(routingpckt/nReceivedPackets));
	for(i = 0; i < max_node; i++){
