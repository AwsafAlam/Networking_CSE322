...
void A_input(struct pkt packet)
{
    ...
    if(getchecksum(packet) == packet.checksum ){
        ...
        else if (packet.acknum < win_start)
        {
            printf("================ Dup ACK received at A outside window [Ignore] ================ \n");
        }
        else{
...
void init() /* initialize the simulator */
{
    ...
    scanf("%f",&corruptprob);
    printf("Enter average time_rdt between messages from sender's layer5 [ > 0.0]: \n");
    scanf("%f",&lambda);
    printf("Enter TRACE: \n");
    scanf("%d",&TRACE);
